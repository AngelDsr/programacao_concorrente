...
class LE:
	...
	def leitorLendo(self,id):
		...
		if (self.escritorEsperando > 0):
			print("ERRO: leitor " + str(id) + " esta lendo quando ha escritor esperando para escrever!")
